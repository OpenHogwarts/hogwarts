...
public class PlayerHotkeys : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            if (gameObject.GetComponent<AchievementPanel>().visible)
                gameObject.GetComponent<AchievementPanel>().visible = false;
            else
                gameObject.GetComponent<AchievementPanel>().visible = true;
        }
